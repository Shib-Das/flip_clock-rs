...
async fn main() {
    ...
    // Try to load font
    // The previous instructions mentioned "If a file named font.ttf exists in the root... copy it to dist/"
    // So the running executable will look for font.ttf in its current directory.
